...
function Register() {
    ...
    const register = (e) => {
        ...
        if(rcode !== '' && codes.includes(rcode.trim().toUpperCase())){
          ...
          setRcode('LUCKY50');
          setCouponMessage('Get Instant 55% Off On Pro Plus And 45% Off On Plus Plan Respectively');
         
         
        }

        if(sites.includes(removeChar())){
          alert('Business Name Exist');
          setCprocessing(false);
          return;
        }
...
<label style={{backgroundColor: 'steelblue', color: 'white', padding: 10, borderRadius: 4, cursor: 'pointer',margin: '20px 0px',display: 'flex',alignItems: 'center',width: 'max-content',margin: '0 auto'}}>
...
<input type='text' placeholder='Your Name' required value={uname} onChange={e => setUname(e.target.value)} />
</div>
<label htmlFor='for' >Phone</label>
<div className='vandore__input'>
<input type='text' placeholder='Your Phone Number' required value={uphone} onChange={e => setUphone(e.target.value)} />
</div>
<label htmlFor='for' >Address</label>
<div className='vandore__input'>
<input type='text' placeholder='Your Address' required value={uaddress} onChange={e => setUaddress(e.target.value)} />
</div>
<label htmlFor='for' >Email</label>
<div className='vandore__input'>
<input type='email' placeholder='Your Email' required value={uemail} onChange={e => setUemail(e.target.value)} /> 
</div>
<label htmlFor='for' >Password</label>
<div className='vandore__input'>
<input type='password' placeholder='Your Password' required value={upassword} onChange={e => setUpassword(e.target.value)} />
</div>
<label htmlFor='for' >Confirm Password</label>
<div className='vandore__input'>
<input type='password' placeholder='Type Your Password Again' required value={ucpassword} onChange={e => setUcpassword(e.target.value)} />
</div>
...
<label htmlFor='for' >Your Brand Name {removeChar()}</label>
<div className='vandore__input'>
